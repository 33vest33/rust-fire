...
{
    [Info("Friends", "Nogrod / RustBurg.ru", "2.1.4", ResourceId = 686)]
	//	friendly fire
	//	friend request
    class Friends : RustPlugin
    {
        ...
        private void Init()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                {"Syntax", "<color=#0EFF6A>Друзья</color><size=7>\n\n</size>  Используйте команду <color=#0EFF6A>/friend add Ник</color> или <color=#0EFF6A>/addfriend Ник</color> чтобы отправить запрос на дружбу<size=7>\n\n</size>  Для того чтобы удалить из друзей используйте команду <color=#0EFF6A>/friend remove Ник</color> или <color=#0EFF6A>/removefriend Ник</color>"},
