...
{
    [Info("Building Upgrade", "Orange", "1.1.1")]
    [Description("Upgrade your buildings quickly!")]
    public class BuildingUpgrade : RustPlugin
    {
        ...
        private class ConfigData
        {
            ...
            [JsonProperty(PropertyName = "2. Check raidblock")]
            public bool checkRaidblock;

            [JsonProperty(PropertyName = "3. Check for full health")]
            public bool checkHealth;
            
            [JsonProperty(PropertyName = "4. Time since last attack")]
            public int attackTime;

            [JsonProperty(PropertyName = "5. GUI settings:")]
        ...
        private class Upgrader : MonoBehaviour
        {
            ...
            {
                if (config.checkRaidblock && plugin.isRaidBlocked(player))
                {
                    Destroy(this);
                    return;
                }
